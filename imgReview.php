...
//determine which labels we're storing
...
if(!isset($_GET['img']))
    die("Set 'img' in the query string");
$imgID = $_GET["img"];
    ...
    function initTables()
    {
        ...
        for(var captionIdx=0; captionIdx < tokenArr_caption.length; captionIdx++)
        {
            ...
            for(var tokenIndex=0; tokenIndex < tokenArr_token.length; tokenIndex++)
            {
                ...
                //too
                if(chainID != "" && chainArr.indexOf(chainID) < 0)
                    chainArr.push(chainID);
                                    ...
                                    <td>
                                        <table style="padding:5px">
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="checkbox" id="chkbx:chunkingCorrect"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="checkbox" id="chkbx:corefCorrect"/>
                                                </td>
                                            </tr>
                                            <tr>
